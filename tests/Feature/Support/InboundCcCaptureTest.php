...
/**
 * Πυλώνας E, Phase 4 — inbound-CC capture. The other parties the sender looped in
 * (To + Cc) become email watchers/CC on the ticket, so our replies copy them too.
 * The sender, the department mailbox and the ticket owner are excluded.
 */
class InboundCcCaptureTest extends TestCase
{
    ...
    public function test_cc_and_to_recipients_become_watchers_minus_sender_and_us(): void
    {
        ...
        // and they were tagged as CC-sourced
