...
class BackupNoteSyncTest extends TestCase
{
    ...
    public function test_sync_is_idempotent_and_tracks_the_remark(): void
    {
        ...
        // Emptied at source → the backup note is removed.
    ...
    public function test_sync_does_not_touch_operator_notes(): void
    {
        ...
        BackupNoteSync::sync($this->tenant->id, $c->id, '');  // would remove backup notes only

        $this->assertDatabaseHas('notes', ['id' => $operatorNote->id]);
    }
