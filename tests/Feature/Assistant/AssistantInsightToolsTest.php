...
class AssistantInsightToolsTest extends TestCase
{
    ...
    public function test_registry_exposes_all_tools(): void
    {
        ...
        $this->assertEqualsCanonicalizing(
            ['count_sales', 'outstanding_receivables', 'list_top_debtors', 'find_customer', 'recent_invoices', 'vat_summary', 'recent_activity', 'app_version', 'send_customer_statement', 'create_reminder'],
            $names,
        );
    }
