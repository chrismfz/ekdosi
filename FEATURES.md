...
- **Αδέσποτα πωλήσεων → σύνδεση ή καταχώριση** (Σελίδα ΜΑΡΚ, `App\Services\MyData\Orphans\*`): για ένα
  ...
  **«Σύνδεση»** (`OrphanLinker`: INSERT row + mirror όπως μια διαβίβαση, χωρίς επαναποστολή/email)· αλλιώς
  **«Καταχώριση τοπικά»** (`OrphanImporter`: όπως δηλώθηκε — σειρά/ΑΑ, ΜΑΡΚ, QR, μία γραμμή ανά γραμμή ΑΑΔΕ με ΦΠΑ/
  εξαίρεση/E3· τα σύνολα πρέπει να συμφωνούν· ο μετρητής της σειράς προχωρά πέρα από τον ΑΑ· πιστωτικά /
  παρακρατήσεις / μη αριθμητικός ΑΑ → χειροκίνητα, με τον λόγο).
