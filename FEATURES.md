...
- **Χρονολόγιο** (`lead_activities`): quick-add Τηλέφωνο / Email / Ραντεβού / Σημείωση με
  ποιος/πότε/κατεύθυνση/αποτέλεσμα/τι ειπώθηκε + προαιρετικό «επόμενο βήμα»· ένα απαντημένο
  τηλέφωνο/email/ραντεβού σε «Νέο» lead το πάει αυτόματα σε «Επικοινωνήσαμε».
...
- **Λίστα**: tabs Ανοιχτά / Νέα / Ληξιπρόθεσμα (πέρασε το επόμενο βήμα) / Αδρανή (14 ημ. χωρίς επαφή)
...
- **Dedupe («να μην ξαναζαλίζουμε κόσμο»)**: banner στη φόρμα όταν το ΑΦΜ/email/τηλέφωνο υπάρχει
  ήδη σε πελάτη ή σε άλλο lead (και χαμένο/διαγραμμένο), κόκκινο για «μην ξαναενοχλήσετε» (`LeadMatcher`).
- **Ρόλοι**: ο κυνηγός = `operator` (Leads στο `OPERATOR_PERMISSION_MAP`)· όλοι βλέπουν όλα.
- _Επόμενα gates: L1 «Μετατροπή σε πελάτη» + link «Προέλευση» + προσφορά από lead· L2 «Απολογισμός
  πωλήσεων» ανά χειριστή + reminders επόμενου βήματος._
