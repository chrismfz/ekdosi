...
- **Προσφορά από lead**: «Νέα προσφορά» στο lead → φόρμα προσφοράς προσυμπληρωμένη (`quotes.lead_id`)·
  η έκδοση γράφει γραμμή «Προσφορά» στο χρονολόγιο και πάει το lead σε «Στάλθηκε προσφορά»· tab
  «Προσφορές» στο lead· στη μετατροπή οι προσφορές περνούν στον πελάτη.
- _Επόμενο gate: L2 «Απολογισμός πωλήσεων» ανά χειριστή + reminders επόμενου βήματος._
