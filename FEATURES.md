...
- **Υπόλοιπο εκδόσεων παρόχου (PROV-009)** — ο πάροχος επιστρέφει σε κάθε έκδοση το quota
  ...
  ομάδα «Εικόνα από myDATA — ΦΠΑ»** του dashboard (ίδια γραμμή με τις 3 κάρτες ΦΠΑ· με επιπλέον
  αναλυτικές κάρτες το πλέγμα γυρίζει σε 3άδες)· αν ο tenant δεν διαβάζει myDATA, πέφτει πίσω στο
