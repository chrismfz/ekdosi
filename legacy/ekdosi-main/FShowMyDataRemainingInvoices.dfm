object FrmShowMyDataRemainingInvoices: TFrmShowMyDataRemainingInvoices
  Left = 0
  Top = 0
  AlphaBlend = True
  Caption = #917#954#954#961#949#956#942' '#960#945#961#945#963#964#945#964#953#954#940' '#947#953#945' MyDATA'
  ClientHeight = 850
  ClientWidth = 983
  Color = clBtnFace
  ...
  object GridInvoices: TcxGrid
    ...
    object ViewInvoices: TcxGridDBTableView
      ...
      OnCellDblClick = ViewInvoicesCellDblClick
      ...
      object ViewInvoicesWITHHOLD_AMOUNT: TcxGridDBColumn
        Caption = #928#945#961#945#954#961#940#964#951#963#951
        DataBinding.FieldName = 'WITHHOLD_AMOUNT'
      end
    end
  ...
  object PanelTop: TJvPanel
    ...
    object PanelSearch: TJvPanel
      ...
      DesignSize = (
        873
        32)
      object EditFromDate: TcxDateEdit
        Left = 100
        Top = 6
        Properties.OnChange = EditFromDatePropertiesChange
        TabOrder = 0
        Width = 121
      end
      object EditToDate: TcxDateEdit
        Left = 244
        Top = 6
        Properties.OnChange = EditFromDatePropertiesChange
        TabOrder = 1
      ...
      object comboPeriod: TcxComboBox
        Left = 704
        Top = 5
        Anchors = [akTop, akRight]
        Properties.Items.Strings = (
          #932#961#941#967#959#957' '#956#942#957#945#962
          #928#961#959#951#947#959#973#956#949#957#959#962' '#956#942#957#945
          #932#961#941#967#959#957' '#967#961#972#957#959#962
          #928#961#959#951#947#959#973#956#949#957#959#962' '#967#961#972#957#959#962)
        Properties.OnChange = comboPeriodPropertiesChange
        TabOrder = 5
        Width = 163
      end
      object ComboState: TcxComboBox
        Left = 572
        Top = 5
        Anchors = [akTop, akRight]
        Properties.Items.Strings = (
          ...
          'Sent'
          'Suppressed')
        Properties.OnChange = ComboStatePropertiesChange
        TabOrder = 6
        Text = 'Pending'
        Width = 126
      end
  ...
  object PanelBottomButtons: TJvPanel
    Left = 0
    Top = 790
    Width = 983
    Height = 41
    ...
    DesignSize = (
      983
      41)
    object cmdSend: TJvDotNetButton
      Left = 8
      Top = 10
      Width = 129
      Height = 25
      Anchors = [akLeft, akBottom]
      Caption = #913#960#959#963#964#959#955#942' '#949#960#953#955#949#947#956#941#957#969#957
      TabOrder = 0
    ...
    object JvDotNetButton1: TJvDotNetButton
      ...
      Height = 25
      Anchors = [akLeft, akBottom]
      Caption = #913#960#959#963#964#959#955#942' '#972#955#969#957
      TabOrder = 1
    ...
    object cmdSuppress: TJvDotNetButton
      Left = 280
      Top = 10
      Width = 129
      Height = 25
  ...
  object DatasetInvoice: TIBDataSet
    ...
    AfterOpen = DatasetInvoiceAfterOpen
    BeforeOpen = DatasetInvoiceBeforeOpen
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from "INVOICE"'
    ...
    InsertSQL.Strings = (
      'insert into "INVOICE"'
        ...
        '   "INVOICE"."ADDRESS2", "INVOICE"."CITY", "INVOICE"."POSTCODE",' +
        ' "INVOICE"."COUNTRY", '
      '   "INVOICE"."NOTES", "INVOICE"."CODE", "INVOICE"."MYDATA_SENT")'
      'values'
        ...
        '   :"PRICE", :"PRICEWVAT", :"NOTES_OLD", :"CONV_INVOICE_ID", :"I' +
        'NVTIME", '
    ...
    ModifySQL.Strings = (
      ...
      '  "INVOICE"."NOTES" = :"NOTES",'
      '  "INVOICE"."CODE" = :"CODE",'
      '  "INVOICE"."MYDATA_SENT" = :"MYDATA_SENT"'
      'where'
      '  "INVOICE"."INVOICE_ID" = :"OLD_INVOICE_ID"')
    ParamCheck = True
  ...
  object ImageList1: TImageList
    ...
    Top = 152
    Bitmap = {
      494C01010C001100780018001800FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object JvPopupMenu1: TJvPopupMenu
    ...
    object Suppress1: TMenuItem
      Caption = 'Suppress'
      OnClick = Suppress1Click
    end
  end
end
