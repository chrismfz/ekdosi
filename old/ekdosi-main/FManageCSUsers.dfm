object FrmManageCSUsers: TFrmManageCSUsers
  Left = 0
  Top = 0
  Caption = 'FrmManageCSUsers'
  ClientHeight = 593
  ClientWidth = 691
  Color = clBtnFace
  ...
  object PanelMain: TJvPanel
    ...
    object GridCSInvoices: TcxGrid
      ...
      object ViewCSCustomers: TcxGridDBTableView
        ...
        object ViewCSCustomersid: TcxGridDBColumn
          Caption = 'ID'
          DataBinding.FieldName = 'id'
        end
        object ViewCSCustomerFullname: TcxGridDBColumn
          DataBinding.FieldName = 'fullname'
          Width = 165
        end
        object ViewCSCustomerscompanyname: TcxGridDBColumn
          Caption = #917#960#969#957#965#956#943#945
          DataBinding.FieldName = 'companyname'
        end
        object ViewCSCustomersaddress1: TcxGridDBColumn
          DataBinding.FieldName = 'address1'
        end
        object ViewCSCustomerscity: TcxGridDBColumn
          DataBinding.FieldName = 'city'
        end
        object ViewCSCustomerspostcode: TcxGridDBColumn
          DataBinding.FieldName = 'postcode'
        end
        object ViewCSCustomersphonenumber: TcxGridDBColumn
          DataBinding.FieldName = 'phonenumber'
        end
        object ViewCSCustomerscredit: TcxGridDBColumn
          DataBinding.FieldName = 'credit'
        end
      end
      object GridCSInvoicessLevel1: TcxGridLevel
        GridView = ViewCSCustomers
      end
    end
  end
  ...
  object jvrltRollDetail: TJvRollOut
    Left = 0
    Top = 352
    Width = 691
    Height = 241
    ...
    object jvpgcntrl1: TJvPageControl
      ...
      object ts1: TTabSheet
        ...
        object lbl3: TLabel
          ...
          Alignment = taRightJustify
          AutoSize = False
          Caption = #917#960#969#957#965#956#943#945' '#917#960#953#967'.'
          Font.Charset = GREEK_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = 'Tahoma'
      ...
      object ts2: TTabSheet
        ...
        object cxDBDateEdit1: TcxDBDateEdit
          Left = 423
          Top = 3
          DataBinding.DataField = 'nextduedate'
          DataBinding.DataSource = DSProducts
          TabOrder = 0
          Width = 121
        end
        object cxDBDateEdit2: TcxDBDateEdit
          Left = 423
          Top = 30
          DataBinding.DataField = 'nextinvoicedate'
          DataBinding.DataSource = DSProducts
          TabOrder = 1
          Width = 121
        end
        object JvPanel2: TJvPanel
          ...
          Caption = 'JvPanel2'
          TabOrder = 2
          object cxgrdGridCSInvoiceLines: TcxGrid
            Left = 1
            Top = 33
            Width = 300
            Height = 154
            ...
            LookAndFeel.Kind = lfStandard
            LookAndFeel.NativeStyle = True
            object ViewUsersProducts: TcxGridDBTableView
              Navigator.Buttons.CustomButtons = <>
              Navigator.Buttons.First.Visible = False
              Navigator.Buttons.PriorPage.Hint = #928#961#959#951#947#959#973#956#949#957#951' '#963#949#955#943#948#945
              Navigator.Buttons.Prior.Enabled = False
              ...
              Styles.ContentEven = StyleEven
              Styles.ContentOdd = StyleOdd
              object ViewUsersProductsid: TcxGridDBColumn
                DataBinding.FieldName = 'id'
              end
              object ViewUsersProductsdomain: TcxGridDBColumn
                Caption = 'Domain'
                DataBinding.FieldName = 'domain'
              end
              object ViewUsersProductspackageid: TcxGridDBColumn
                Caption = 'Package'
                DataBinding.FieldName = 'packagename'
              end
              object ViewUsersProductsserver: TcxGridDBColumn
                Caption = 'Server'
                DataBinding.FieldName = 'servername'
              end
            end
            object cxgrdlvlLevel1InvoiceLines: TcxGridLevel
              GridView = ViewUsersProducts
            end
          end
      ...
      object TabSheet1: TTabSheet
        ...
        object JvPanel4: TJvPanel
          ...
          object cxGrid1: TcxGrid
            ...
            LookAndFeel.Kind = lfStandard
            LookAndFeel.NativeStyle = True
            object ViewCSDomains: TcxGridDBTableView
              Navigator.Buttons.CustomButtons = <>
              Navigator.Buttons.First.Visible = False
              Navigator.Buttons.PriorPage.Hint = #928#961#959#951#947#959#973#956#949#957#951' '#963#949#955#943#948#945
              Navigator.Buttons.Prior.Enabled = False
              ...
              Navigator.Visible = True
              DataController.DataModeController.SmartRefresh = True
              DataController.DataSource = DSDomains
              DataController.Filter.AutoDataSetFilter = True
              DataController.Summary.DefaultGroupSummaryItems = <
                item
                  Kind = skSum
              ...
              Styles.ContentEven = StyleEven
              Styles.ContentOdd = StyleOdd
              object ViewCSDomainsid: TcxGridDBColumn
                Caption = 'ID'
                DataBinding.FieldName = 'id'
                Width = 32
              end
              object ViewCSDomainsdomain: TcxGridDBColumn
                Caption = 'Domain'
                DataBinding.FieldName = 'domain'
              end
              object ViewCSDomainsregistrationdate: TcxGridDBColumn
                Caption = 'Registered'
                DataBinding.FieldName = 'registrationdate'
              end
              object ViewCSDomainsexpirydate: TcxGridDBColumn
                Caption = 'Expiration'
                DataBinding.FieldName = 'expirydate'
              end
              object ViewCSDomainsrecurringamount: TcxGridDBColumn
                Caption = 'Price'
                DataBinding.FieldName = 'recurringamount'
              end
              object ViewCSDomainstype: TcxGridDBColumn
                Caption = 'Type'
                DataBinding.FieldName = 'type'
                Visible = False
              end
              object ViewCSDomainsregistrar: TcxGridDBColumn
                DataBinding.FieldName = 'registrar'
                Visible = False
              end
              object ViewCSDomainsregistrationperiod: TcxGridDBColumn
                DataBinding.FieldName = 'registrationperiod'
                Visible = False
              end
              object ViewCSDomainsfirstpaymentamount: TcxGridDBColumn
                DataBinding.FieldName = 'firstpaymentamount'
                Visible = False
              end
              object ViewCSDomainssubscriptionid: TcxGridDBColumn
                DataBinding.FieldName = 'subscriptionid'
                Visible = False
              end
              object ViewCSDomainspromoid: TcxGridDBColumn
                DataBinding.FieldName = 'promoid'
                Visible = False
              end
              object ViewCSDomainsstatus: TcxGridDBColumn
                DataBinding.FieldName = 'status'
                Visible = False
              end
              object ViewCSDomainsnextduedate: TcxGridDBColumn
                DataBinding.FieldName = 'nextduedate'
                Visible = False
              end
              object ViewCSDomainsnextinvoicedate: TcxGridDBColumn
                DataBinding.FieldName = 'nextinvoicedate'
                Visible = False
              end
              object ViewCSDomainsadditionalnotes: TcxGridDBColumn
                DataBinding.FieldName = 'additionalnotes'
                Visible = False
              end
              object ViewCSDomainspaymentmethod: TcxGridDBColumn
                DataBinding.FieldName = 'paymentmethod'
                Visible = False
              end
              object ViewCSDomainsdnsmanagement: TcxGridDBColumn
                DataBinding.FieldName = 'dnsmanagement'
                Visible = False
              end
              object ViewCSDomainsemailforwarding: TcxGridDBColumn
                DataBinding.FieldName = 'emailforwarding'
                Visible = False
              end
              object ViewCSDomainsidprotection: TcxGridDBColumn
                DataBinding.FieldName = 'idprotection'
                Visible = False
              end
              object ViewCSDomainsdonotrenew: TcxGridDBColumn
                DataBinding.FieldName = 'donotrenew'
                Visible = False
              end
            end
            object cxGridLevel1: TcxGridLevel
              GridView = ViewCSDomains
            end
          end
          object JvPanel5: TJvPanel
            ...
            object JvToolBar3: TJvToolBar
              ...
              object ToolEditDomains: TToolButton
                Left = 72
                Top = 0
                Hint = #917#960#949#958#949#961#947#945#963#943#945
                Caption = 'ToolEdit'
                ImageIndex = 4
                OnClick = ToolEditDomainsClick
              end
              object ToolAcceptDomains: TToolButton
                Left = 104
                Top = 0
                Hint = #913#960#959#948#959#967#942
                Caption = 'ToolAccept'
                Enabled = False
                ImageIndex = 5
                OnClick = ToolAcceptDomainsClick
              end
              object ToolCancelDomains: TToolButton
                Left = 136
                Top = 0
                Hint = #913#960#972#961#961#953#968#951
                Caption = 'ToolCancel'
                Enabled = False
                ImageIndex = 6
                OnClick = ToolCancelDomainsClick
              end
        ...
        object cxDBDateEdit3: TcxDBDateEdit
          ...
          Top = 43
          DataBinding.DataField = 'nextduedate'
          DataBinding.DataSource = DSDomains
          TabOrder = 1
          Width = 121
        end
  ...
  object ImageList1: TImageList
    ...
    Top = 152
    Bitmap = {
      494C01010C0011001C0018001800FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object QueryPackages: TUniQuery
    SQL.Strings = (
      'select tblinvoices.*,'
      '      b.companyname,'
      '      b.address1,'
      ...
      '      '
        ...
        '        from tblinvoices left outer join tblclients b on tblinvo' +
        'ices.userid = b.id'
      
        '      where tblinvoices.status ='#39'Paid'#39'  and tblinvoices.invoiced' +
        ' = 0'
    ...
    object WideMemoField20: TWideMemoField
    ...
    object WideMemoField21: TWideMemoField
      FieldName = 'status'
      Required = True
      BlobType = ftWideMemo
    end
    object WideMemoField22: TWideMemoField
      FieldName = 'paymentmethod'
      Required = True
      BlobType = ftWideMemo
    end
    object WideMemoField23: TWideMemoField
      FieldName = 'notes'
      Required = True
      BlobType = ftWideMemo
    end
    ...
    object WideMemoField24: TWideMemoField
      FieldName = 'companyname'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField25: TWideMemoField
      FieldName = 'address1'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField26: TWideMemoField
      FieldName = 'address2'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField27: TWideMemoField
      FieldName = 'city'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField28: TWideMemoField
      FieldName = 'state'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField29: TWideMemoField
      FieldName = 'postcode'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField30: TWideMemoField
      FieldName = 'country'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField31: TWideMemoField
      FieldName = 'phonenumber'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField32: TWideMemoField
      FieldName = 'email'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField33: TWideMemoField
      FieldName = 'firstname'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField34: TWideMemoField
      FieldName = 'lastname'
      ReadOnly = True
      BlobType = ftWideMemo
    end
  ...
  object QueryClients: TUniQuery
    ...
    object WideMemoField9: TWideMemoField
      FieldName = 'state'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField10: TWideMemoField
      FieldName = 'postcode'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField11: TWideMemoField
      FieldName = 'country'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField12: TWideMemoField
      FieldName = 'phonenumber'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField13: TWideMemoField
      FieldName = 'email'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField14: TWideMemoField
      FieldName = 'firstname'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField15: TWideMemoField
      FieldName = 'lastname'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField16: TWideMemoField
      FieldName = 'toinvoice'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField17: TWideMemoField
      FieldName = 'occupation'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField18: TWideMemoField
      FieldName = 'vatno'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object WideMemoField19: TWideMemoField
      FieldName = 'taxoffice'
      ReadOnly = True
      BlobType = ftWideMemo
    end
