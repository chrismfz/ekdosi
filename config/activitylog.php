...
return [
     ...
     *
     * Ours (App\Models\Activity) extends the package model and stamps the
     * tenant `company_id` from the subject on write, so a per-tenant activity
     * feed can scope cleanly.
     */
