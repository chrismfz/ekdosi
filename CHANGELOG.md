...
- **Σελίδα προβολής παραστατικού: πιο συμπαγή τα πάνω cards.** Τα «Identification» και «Customer»
  γίνονται `compact` (λιγότερο padding) ώστε να πιάνουν λιγότερο κατακόρυφο χώρο — προετοιμασία για
  μελλοντικό περιεχόμενο από κάτω. Μόνο διάταξη, κανένα πεδίο δεν αφαιρέθηκε.
