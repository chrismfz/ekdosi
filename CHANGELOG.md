...
- **Έξοδα: «Σημειώσεις» ανά παραστατικό.** Ιδιωτικές σημειώσεις χειριστή (π.χ. «εισιτήριο Aegean»),
  ...
  στην προβολή εξόδου.
- **`suppliers:backfill-names`** — συμπληρώνει επωνυμία/ΔΟΥ/διεύθυνση από ΑΑΔΕ (GSIS) στους
  «αδέσποτους» προμηθευτές που είχαν δημιουργηθεί μόνο με ΑΦΜ πριν το fix (fill-only-empty, best-effort).
