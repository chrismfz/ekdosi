...
- **Guard στην «Είσπραξη (έμβασμα)» της Καρτέλας: τέλος ο κατά-λάθος πιστωτικός πελάτης.** Η ενέργεια
  κατανέμει FIFO **μόνο σε ανοιχτά επί-πιστώσει τιμολόγια**, οπότε σε πελάτη ΧΩΡΙΣ ανοιχτά (π.χ. μόνο
  τοις μετρητοίς) όλο το ποσό έπεφτε σιωπηλά ως on-account πίστωση και ο πελάτης εμφανιζόταν πιστωτικός.
  Πλέον, όταν δεν υπάρχει ανοιχτό υπόλοιπο να απορροφήσει το ποσό, η modal το λέει ρητά **και απαιτεί
  checkbox επιβεβαίωσης**· διαφορετικά δείχνει το διαθέσιμο ποσό κάλυψης. Η «Πληρωμή έναντι λογαριασμού»
  απέκτησε αντίστοιχη επεξήγηση. Και οι δύο παραπέμπουν στο σωστό μονοπάτι για είσπραξη **συγκεκριμένου**
  τιμολογίου: άνοιξε το τιμολόγιο → «Πληρωμές» → «Καταχώριση πληρωμής» (δένεται στο τιμολόγιο, δεν βγάζει
  πιστωτικό).
