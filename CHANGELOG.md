...
### Fixed
- **Ένα παραστατικό που εκδόθηκε με αριθμό στην οριστικοποίηση δεν γυρίζει πια σε πρόχειρο.** Σε tenant χωρίς
  διαβίβαση (π.χ. Nixpal) και σε άτυπη σειρά η οριστικοποίηση είναι η έκδοση· ως τώρα ένα εκδομένο (ήδη στον
  πελάτη/λογιστή) μπορούσε — με «Επαναφορά σε πρόχειρο» ή ακύρωση → «Επαναφορά» — να αλλάξει και να
  ξαναοριστικοποιηθεί με τον ίδιο αριθμό. Τώρα η πρώτη κρύβεται και η δεύτερη το φέρνει πίσω «Ενεργό». Διόρθωση =
  ακύρωση και νέο· το λέει και το μήνυμα της οριστικοποίησης. Σε tenant που διαβιβάζει, ένα απορριφθέν μένει
  διορθώσιμο, αλλά όχι μια αποστολή «σε αμφιβολία» (μπορεί να έχει ήδη ΜΑΡΚ — η επανυποβολή το συμφιλιώνει).
