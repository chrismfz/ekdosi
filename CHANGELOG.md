...
- **Άτυπη (μη φορολογική) σειρά + προεπιλεγμένο είδος παραστατικού ανά πελάτη.** Νέα σημαία «Άτυπη σειρά» στο είδος
  ...
  email/πύλη/UBL/πιστωτικό· η σημαία κλειδώνει όταν η σειρά έχει οποιοδήποτε παραστατικό, και ένα αριθμημένο
  παραστατικό δεν αλλάζει ποτέ από άτυπη σε φορολογική σειρά (ή ανάποδα). Ο πελάτης αποκτά «Προεπιλεγμένο είδος
