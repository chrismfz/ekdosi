...
- **Αδέσποτα myDATA: «Σύνδεση» με υπάρχον ή «Καταχώριση τοπικά».** Στη σελίδα ΜΑΡΚ ενός αδέσποτου (υπάρχει στο
  myDATA, όχι τοπικά): λίστα πιθανών τοπικών παραστατικών χωρίς ΜΑΡΚ (ίδια σειρά/ΑΑ, ίδιο ποσό, ΑΦΜ, ημερομηνία) με
  κουμπί **«Σύνδεση»** — γράφει ΜΑΡΚ/QR/κατάσταση όπως μια διαβίβαση, χωρίς επαναποστολή στο ΑΑΔΕ ή email στον πελάτη.
  ...
  διαβιβασμένο ή ακυρωμένο· ο μετρητής της σειράς προχωρά ώστε ο ίδιος ΑΑ να μη δοθεί ξανά. Πιστωτικά, παρακρατήσεις
  και σύνολα που δεν συμφωνούν απορρίπτονται με τον λόγο (χειροκίνητα). Αντικαθιστά το placeholder κουμπί.
