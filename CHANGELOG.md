...
- **Έλεγχος αιτίας απαλλαγής ΦΠΑ (§8.3) ↔ τύπου παραστατικού.** Μια 0% γραμμή με αιτία που δεν στέκει ποτέ για τον
  ...
  δέχεται τέτοιο παραστατικό, άρα η λάθος νομική αιτία περνούσε σιωπηλά (MYD-007). ⚠ Tenant με μία 0% κατηγορία ΦΠΑ
  σε αιτία 16 (παλιά προεπιλογή): τα 2.2 χωρίς αιτία γραμμής (π.χ. από WHMCS) θα σταματήσουν — όρισε την κατηγορία σε 4.
