...
- **Άτυπη (μη φορολογική) σειρά + προεπιλεγμένο είδος παραστατικού ανά πελάτη.** Νέα σημαία «Άτυπη σειρά» στο είδος
  ...
  email/πύλη/UBL/πιστωτικό· η σημαία κλειδώνει όταν η σειρά έχει εκδοθέντα. Ο πελάτης αποκτά «Προεπιλεγμένο είδος
  παραστατικού» που προ-συμπληρώνει νέα παραστατικά και υπηρεσίες (π.χ. η εταιρεία μας → ΕΣΩ).
