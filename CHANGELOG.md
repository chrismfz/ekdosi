...
- **Το DB probe του installer έλεγε «πίνακες που δεν φαίνονται εγκατάσταση ekdosi» για… ekdosi schema.** Μια
  ...
  και οδηγεί στο «Συνέχεια σε μη-κενή βάση» για ολοκλήρωση· οι πραγματικά ξένες βάσεις κρατούν το παλιό
  μήνυμα. Ίδια ασφάλεια (override πάντα απαιτείται), μόνο η διάγνωση/διατύπωση αλλάζει.
