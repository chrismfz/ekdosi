...
- **Το «Υπόλοιπο εκδόσεων» του παρόχου ανέβηκε ψηλά στο dashboard.** Η κάρτα δεν είναι πια
  ...
  «Εικόνα από myDATA — ΦΠΑ»** (`MyDataPictureStats`), με ετικέτα «Πάροχος — Υπόλοιπο εκδόσεων» —
  στην ίδια γραμμή με τις 3 κάρτες ΦΠΑ (αν η εικόνα έχει και αναλυτικές κάρτες μη-πωλήσεων, το
  πλέγμα γυρίζει σε 3άδες και η κάρτα πέφτει στη 2η γραμμή, πάντα ψηλά). Το
