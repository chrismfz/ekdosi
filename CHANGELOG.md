...
- **Σελίδα προβολής παραστατικού: πιο συμπαγή τα πάνω cards.** Τα «Identification» και «Customer»
  ...
  link** («Άνοιγμα εγγραφής →») αντί για ολόκληρη την επωνυμία (που «έσπαγε» σε 5–7 γραμμές δίπλα στο
  νόμιμο snapshot «Name on invoice») — έτσι το card «Πελάτης» μικραίνει αισθητά καθ' ύψος και
  ελευθερώνεται χώρος από κάτω. Το link οδηγεί στη ζωντανή καρτέλα πελάτη· καμία απώλεια πληροφορίας.
