...
- **Αδέσποτα myDATA: «Σύνδεση» με υπάρχον ή «Καταχώριση τοπικά».** Στη σελίδα ΜΑΡΚ ενός αδέσποτου (υπάρχει στο
  ...
  (`invoices.origin`): χωρίς «Νέο υπόλοιπο» και χωρίς αυτόματες υπενθυμίσεις· προεπιλογή πληρωμής «μετρητοίς». Πιστωτικά,
  παρακρατήσεις και σύνολα που δεν συμφωνούν στο λεπτό απορρίπτονται με τον λόγο. Αντικαθιστά το placeholder κουμπί.
