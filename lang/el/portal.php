...
return [
    ...
    'statement' => [
        ...
        'total_charges' => 'Σύνολο χρεώσεων (στο υπόλοιπο)',
        'total_credit_notes' => 'Πιστωτικά',
    ...
    'payment' => [
        'credit_pick_one' => 'Διάλεξε τουλάχιστον ένα παραστατικό.',
        'credit_nothing_applied' => 'Δεν εφαρμόστηκε τίποτα — τα παραστατικά που διάλεξες δεν έχουν ανοιχτό υπόλοιπο.',
        'use_credit_multi_hint' => 'Διάλεξε όσα θέλεις — η πίστωση πάει στο καθένα με τη σειρά, μέχρι να εξαντληθεί.',
        'available_credit' => 'Πιστωτικό υπόλοιπο (υπέρ σου)',
        'use_credit' => 'Χρήση πίστωσης',
        'use_credit_hint' => 'Έχεις :amount πίστωση. Διάλεξε παραστατικό για να την εξοφλήσεις χωρίς νέα πληρωμή.',
        'use_credit_submit' => 'Εξόφληση από την πίστωση',
        'credit_applied' => 'Εξοφλήθηκαν :amount στο :document από την πίστωσή σου.',
        'proforma_badge' => 'Προτιμολόγιο',
        'proforma_note' => 'Προτιμολόγιο — δεν αποτελεί φορολογικό παραστατικό. Θα εκδοθεί το οριστικό μόλις εξοφληθεί.',
    ...
    // «Online προβολή» ενός παραστατικού (read-only reference, όχι το νόμιμο PDF).
    'document' => [
        'title' => 'Παραστατικό',
        'issuer' => 'Εκδότης',
        'recipient' => 'Προς',
        'line_description' => 'Περιγραφή',
        'qty' => 'Ποσότητα',
        'unit_price' => 'Τιμή μον.',
        'vat' => 'ΦΠΑ',
        'net' => 'Καθαρή αξία',
        ...
        'gross_total' => 'Σύνολο (με ΦΠΑ)',
        'payable' => 'Πληρωτέο',
        'paid' => 'Πληρωμένο',
        'payment_status' => 'Κατάσταση πληρωμής',
        'status_paid' => 'Εξοφλημένο',
        'status_partial' => 'Μερική εξόφληση',
        'status_unpaid' => 'Ανεξόφλητο',
        'status_credited' => 'Πιστωμένο',
        'status_overpaid' => 'Υπερπληρωμή',
        'linked_title' => 'Συνδεδεμένα παραστατικά',
        'credit_of' => 'Πιστωτικό για το παραστατικό',
        'credit_notes' => 'Πιστωτικά που εκδόθηκαν',
        'receipts' => 'Εισπράξεις / Πληρωμές',
        'method' => 'Τρόπος',
        'no_links' => 'Δεν υπάρχουν συνδεδεμένα παραστατικά.',
        'back_to_documents' => 'Πίσω στα παραστατικά',
    ],

    // «Απόδειξη/είσπραξη» — άτυπη προβολή μιας πληρωμής/είσπραξης/εμβάσματος.
    'receipt' => [
        'kind_payment' => 'Πληρωμή',
        'kind_collection' => 'Είσπραξη',
        'kind_remittance' => 'Έμβασμα',
        'kind_refund' => 'Επιστροφή χρημάτων',
        'channel' => 'Κανάλι / προέλευση',
        'channel_manual' => 'Χειροκίνητα',
        'channel_portal' => 'Ηλεκτρονική πύλη',
        'channel_mixed' => 'Πολλαπλά κανάλια',
        'method' => 'Τρόπος πληρωμής',
        'bank_account' => 'Λογαριασμός',
        'transaction_id' => 'Κωδικός συναλλαγής',
        'reference' => 'Αναφορά',
        'notes' => 'Αιτιολογία',
        'received_by' => 'Εισπράχθηκε από',
        'from_customer' => 'Από',
        'settles' => 'Εξοφλεί',
        'on_account' => 'Πίστωση / προκαταβολή',
        'back_to_statement' => 'Πίσω στην καρτέλα',
        'informal_note' => 'Άτυπη προβολή κίνησης — δεν αποτελεί φορολογικό παραστατικό.',
    ],
