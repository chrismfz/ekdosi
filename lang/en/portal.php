...
return [
    ...
    // Online view of a single document (read-only reference, not the legal PDF).
    'document' => [
        'title' => 'Document',
        'issuer' => 'Issuer',
        'recipient' => 'To',
        ...
        'linked_title' => 'Linked documents',
        'credit_of' => 'Credit note for document',
        'credit_notes' => 'Credit notes issued',
