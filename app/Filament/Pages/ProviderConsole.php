        ...
        return [
            Action::make('ping')
                ...
                ->action(function () {
                    ...
                    $ok
                        ? Notification::make()->title('Ο πάροχος είναι προσβάσιμος')->body('Η διεύθυνση απαντά — έλεγχος μόνο διαθεσιμότητας. ΔΕΝ επαληθεύει διαπιστευτήρια ή υπόλοιπο (quota)· αυτά ελέγχονται στην πρώτη πραγματική αποστολή.')->success()->send()
