...
class ScheduleSettings extends Page implements HasForms
{
    ...
    private const TASKS = [
        ...
        // Προσωπικό / ΕΡΓΑΝΗ
        'ergani_watch_enabled' => ['ΕΡΓΑΝΗ — εβδομαδιαίος φύλακας (κάρτα + προσωπικό)', 'Μία φορά την εβδομάδα διαβάζει από το ΕΡΓΑΝΗ (Παραγωγή, μόνο ανάγνωση) αν η εταιρεία εντάχθηκε στην Ψηφιακή Κάρτα Εργασίας, και συγκρίνει το δυναμικό του ΕΡΓΑΝΗ με τους «Εργαζόμενους» (νέοι / αποχωρήσαντες). Ειδοποιεί τους διαχειριστές μόνο όταν κάτι αλλάξει. Δεν δηλώνει και δεν αλλάζει τίποτα.', false],
        // Υποστήριξη & domains
    ...
    private const TIMINGS = [
        ...
        'ergani_watch_cron' => ['ΕΡΓΑΝΗ — εβδομαδιαίος φύλακας', 'cron'],
