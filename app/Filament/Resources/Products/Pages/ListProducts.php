...
class ListProducts extends BaseListRecords
{
    ...
    private function importLeviedTemplatesAction(): Action
    {
        ...
        return Action::make('import_levied_templates')
            ...
            ->modalDescription('Έτοιμα προϊόντα/τέλη, προ-ρυθμισμένα με το σωστό myDATA τέλος (§8.7). Διάλεξε ποια να δημιουργηθούν — το τέλος υπολογίζεται μετά αυτόματα ανά παραστατικό. Προσοχή: δύο διαφορετικά τέλη ΙΔΙΟΥ τύπου (π.χ. σακούλα + ανακύκλωσης) δεν μπαίνουν στο ΙΔΙΟ παραστατικό — χώρισέ τα.')
