                                ...
                                Section::make('Επιλογές αποστολής')
                                    ...
                                    ->schema([
                                        Toggle::make('mydata_send_item_descr')
                                            ...
                                            ->helperText('Η ΑΑΔΕ ΔΕΝ απαιτεί την περιγραφή ανά γραμμή (το myDATA κρατά μόνο αξίες/ΦΠΑ/κατηγοριοποίηση εσόδων — η παλιά εφαρμογή δεν την έστελνε). Άφησέ το κλειστό για payload ταυτόσημο με το δοκιμασμένο. Άνοιξέ το για να εμφανίζεται το κείμενο της γραμμής στη σελίδα επιβεβαίωσης/QR της ΑΑΔΕ. ⚠ Δοκίμασέ το πρώτα στο Sandbox.')
                                            ->default(false),
                                    ]),
                            ]),
