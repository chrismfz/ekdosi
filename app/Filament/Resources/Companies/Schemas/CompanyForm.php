                        ...
                        Tab::make('ΕΡΓΑΝΗ')
                            ...
                            ->schema([
                                Toggle::make('ergani_enabled')
                                    ...
                                    ->helperText('Ενεργοποιεί τον πυλώνα Προσωπικό για αυτή την εταιρεία: εργαζόμενοι, άδειες, ημερολόγιο αδειών, τοπικές αργίες και τον ρόλο «Προσωπικό (άδειες & κάρτα)». Ανενεργό = τελείως κρυμμένο.')
                                    ->live(),
                                ...
                                Section::make('Σύνδεση ΕΡΓΑΝΗ ΙΙ')
                                    ...
                                    ->schema([
                                        ...
                                        TextInput::make('ergani_password')
                                            ...
                                            ->dehydrated(fn (?string $state): bool => filled($state))
                                            ->maxLength(255),
                                        Toggle::make('ergani_submit_leaves')
                                            ->label('Αυτόματη δήλωση εγκεκριμένων αδειών στο ΕΡΓΑΝΗ')
                                            ->helperText(fn (callable $get): string => ($get('ergani_mode') === 'production'
                                                ? '⚠ ΠΑΡΑΓΩΓΗ: κάθε έγκριση δηλώνεται ΠΡΑΓΜΑΤΙΚΑ (WTOLeave) και κάθε ανάκληση ανακαλείται. '
                                                : 'Δοκιμαστικό: οι δηλώσεις φέρουν «ΑΚΥΡΟ». ')
                                        ...
                                        Toggle::make('ergani_submit_cards')
                                            ...
                                            ->columnSpanFull(),
                                        Toggle::make('ergani_submit_overtime')
                                            ->label('Δήλωση υπερωριών στο ΕΡΓΑΝΗ')
                                            ->helperText(fn (callable $get): string => ($get('ergani_mode') === 'production'
                                                ? '⚠ ΠΑΡΑΓΩΓΗ: κάθε «Νέα υπερωρία» δηλώνεται ΠΡΑΓΜΑΤΙΚΑ (WTOOv) — δεν ανακαλείται. '
                                                : 'Δοκιμαστικό: οι δηλώσεις φέρουν «ΑΚΥΡΟ». ')
                                                .'Ενεργοποιεί τη σελίδα «Υπερωρίες» (δήλωση πριν την έναρξη).')
                                            ->columnSpanFull(),
