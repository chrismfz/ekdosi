                        ...
                        Tab::make('Address & contact')
                            ->schema([
                                ...
                                Toggle::make('reminders_enabled')
                                    ->label('Υπενθυμίσεις πληρωμής')
                                    ->default(true)
                                    ->helperText('Όταν είναι ενεργό, ο πελάτης παίρνει τις υπενθυμίσεις για ανεξόφλητα (εφόσον τις έχει ενεργοποιήσει η εταιρεία). Κλείσ\'το για πελάτες που δεν θέλεις να «ενοχλείς».')
                                    ->columnSpanFull(),
                            ])
                            ->columns(2),
