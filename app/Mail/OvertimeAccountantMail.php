...
class OvertimeAccountantMail extends Mailable
{
    ...
    public function intro(): string
    {
        ...
        return match ($o->ergani_status) {
            ...
            // Informational ONLY: the company retries from ekdosi — if the accountant also
            // declared it by hand there would be two binding, non-withdrawable WTOOv.
            'unknown' => 'Η αυτόματη δήλωση της παρακάτω υπερωρίας έχει ΑΓΝΩΣΤΟ αποτέλεσμα. Την ελέγχει η εταιρεία — ΜΗΝ τη δηλώσετε εσείς χωρίς να σας το ζητήσουμε.',
            default => 'Η παρακάτω υπερωρία ΔΕΝ δηλώθηκε αυτόματα στο ΕΡΓΑΝΗ. Η εταιρεία θα την ξαναδηλώσει από το ekdosi ή θα σας ενημερώσει — ΜΗΝ τη δηλώσετε εσείς χωρίς να σας το ζητήσουμε.',
        };
    }
