...
class CustomerLedgerBuilder
{
    ...
    private function loadInvoices(Customer $customer): Collection
    {
        return DB::table('invoices')
            ...
            // Paid προτιμολόγια are kept: loadPayments() counts their payment, so
            // dropping their charge drove the customer's balance negative.
            ->when(true, fn ($q) => InvoiceScope::excludeUnpaidUnissuedDrafts($q))
