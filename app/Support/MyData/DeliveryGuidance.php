...
class DeliveryGuidance
{
    ...
    public const FIELD_HELP = [
        ...
        'non_obligated_recipient' => 'Ο παραλήπτης δεν έχει υποχρέωση επιβεβαίωσης (ιδιώτης ή επιχείρηση χωρίς ERP/ψηφιακή παραλαβή). Με δικό μας όχημα, το «Παραδόθηκε» κλείνει τη διακίνηση αμέσως· αλλιώς ο πελάτης την κλείνει σκανάροντας το QR.',
