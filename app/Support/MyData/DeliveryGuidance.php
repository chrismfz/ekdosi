...
class DeliveryGuidance
{
    ...
    public const SCENARIOS = [
        ...
        'internal' => [
            'label' => 'Μεταφέρω δικό μου εξοπλισμό/εμπόρευμα σε άλλη εγκατάσταση ή αποθήκη',
            'move_purpose' => 8, // Ενδοδιακίνηση
            'hint' => 'Ενδοδιακίνηση — π.χ. μετακίνηση server από Ξάνθη στο datacenter. Δεν είναι πώληση. (Το «Διακίνηση Παγίων» δεν δηλώνεται πλέον — η Ενδοδιακίνηση το καλύπτει.)',
        ],
        'repair' => [
            'label' => 'Στέλνω κάτι για σέρβις / επισκευή',
            'move_purpose' => 19, // Λοιπές Διακινήσεις
            'other_title' => 'Αποστολή για επισκευή',
            'hint' => 'Αποστολή για επισκευή/συντήρηση. Δηλώνεται ως «Λοιπές Διακινήσεις» με τίτλο.',
        ],
        'return' => [
    ...
    public const FIELD_HELP = [
        ...
        'move_purpose' => 'Γιατί κινείται το αγαθό (σκοπός διακίνησης). Καθορίζει πώς το βλέπει η ΑΑΔΕ. Οι κωδικοί που δεν γίνονται δεκτοί πλέον (π.χ. «Διακίνηση Παγίων») δεν εμφανίζονται.',
