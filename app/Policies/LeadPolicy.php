...
/**
 * Shield-style policy for Leads (same shape shield:generate emits). No
 * ownership / visibility rules by design: everyone in the tenant sees and
 * works every lead (owner decision — cover absences/holidays).
 */
class LeadPolicy
{
