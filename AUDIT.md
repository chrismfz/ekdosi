...
- [x] **MYD-8 · LOW — ✅ FIXED 2026-07-06** (νέο `Codes::vatRateFileable(rate, override)`: το 3% είναι fileable ΜΟΝΟ με έγκυρο §8.2 override — το 4% ήδη fileable απευθείας· τα δύο audit surfaces (VAT-categories badge + ETL warning) έγιναν override-aware) — έπαυσε το ψευδο-warning σε σωστά ρυθμισμένο 3% row.
