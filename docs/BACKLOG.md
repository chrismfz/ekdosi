...
- **Ιδέες ορατότητας/insights (όλες read-only προς ΕΡΓΑΝΗ, «θεμιτές» — owner 2026-09-26):** ~~κάρτα «ΕΡΓΑΝΗ» στο dashboard~~,
  ...
  (UI πάνω στο `ergani_submissions` + PDF) · **διασταύρωση αδειών ekdosi↔ΕΡΓΑΝΗ** (⚠ το `Lookup_Submissions` είναι μόνο ο κατάλογος εντύπων — δηλώσεις τρίτων φαίνονται
  ...
  δυναμικού (`EX_BASE_05` diff) · PDF ΕΡΓΑΝΗ στο email λογιστή / «Οι άδειές μου» · οδηγός «Πέρασμα σε Παραγωγή»
