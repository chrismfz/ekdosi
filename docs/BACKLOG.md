...
- **Πυλώνας A — Domains** _(OPEN, πρώτο)_ — **αναλυτικό design: `docs/domains/README.md`** (data
  ...
  - **A3** Openprovider write — **A3a (renew + adopt guard) ✅ + A3b (register, adopt-on-retry)
    ✅ SHIPPED** (βλ. `FEATURES.md §21`)· μένουν A3c transfer in/out + Get EPP code, A3d
    NS/contacts/DNSSEC/lock writes + grace/redemption χρεώσεις. Για τον A5 reconciler (μαζί με τα υπόλοιπα A3):
