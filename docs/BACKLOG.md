...
- **Υπηρεσίες/domains χωρίς χρέωση (δικές μας / φίλων / υπαλλήλων) — ΠΡΙΝ τη μεταφορά υπηρεσιών από WHMCS.**
  ...
  PDF + προεπιλογή πελάτη → `FEATURES.md §2`). **Μένουν (PR 2):** «Μετατροπή σε φορολογικό» (ΕΣΩ→ΤΠΥ/ΤΙΜ/ΑΛΠ,
  χωρίς σύνδεση σύμβασης — αλλιώς διπλή ανανέωση) · μαζική «Αλλαγή σειράς» υπηρεσιών · επισήμανση στο inbox της
  WHMCS · αναφορά αξίας. Φορολογικά (6.2 ιδιοχρησιμοποίηση;) → λογιστής.
