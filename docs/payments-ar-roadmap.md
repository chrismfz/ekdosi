...
## 🤔 Considered & ΑΠΟΡΡΙΦΘΗΚΕ (όχι gap)
- **Auto-γραμμή πληρωμής στα νέα μετρητοίς τιμολόγια** (να υλοποιείται η «είσπραξη
  έκδοσης» ως πραγματική γραμμή αντί synthetic). Η χειροκίνητη «Καταχώριση
  πληρωμής» (cash-term money-trail PR) ήδη καλύπτει την ανάγκη· η auto-γραμμή
  προσθέτει double-count/credit ρίσκο + lifecycle πολυπλοκότητα για οριακό
  όφελος. Το synthetic «εξοφλημένο στην έκδοση» μένει default. Επανεξέταση μόνο
  αν προκύψει πραγματική ανάγκη (+ guard «διόρθωσε, μην προσθέτεις δεύτερη»).
- **Backfill ψεύτικων γραμμών στα ~6.7k imported** — όχι· κατασκευή λογιστικών
  εγγραφών που δεν υπήρξαν, μηδέν νέα πληροφορία, ρίσκο audit. Μένουν synthetic.
